...
muz_1 = violator_songs_list[3][1]
muz_2 = violator_songs_list[5][1]
muz_3 = violator_songs_list[8][1]
min = muz_1 + muz_2 + muz_3
min = round(min, 2)
print('Три песни звучат', min, 'минут')
...
min_3 = violator_songs_dict['Blue Dress']
sum = min_1 + min_2 + min_3
sum = round(sum, 2)
